# Pitstop Academy
This is my First project on the Full Stack Web Developer at Code Institute course. The aim was to build a front-end website that was fully responsive on all devices widths mobile, tablet and desktop. After reading the brief, I decided to create my own unique website about a training academy for tyre fitting as this is something I have always felt is needed in the industry from my experience.
...
and training in the workplace. These practices are passed on to collegues and employees down the line who may be doing things 
wrong even though they seem right because its how they were shown. Pitstop Academy aims to stop this and teach
workers more about theory and principles of tyre fitting and all the work related. This will lead to a higher standard of work
...
The Navigation bar features on all pages of the website except for the safety course application form. It is fully responsive, includes links to the Home page, Courses page and the Apply Now page. It is identical in each page to allow for easy navigation. The nav bar will let the user easily navigate from page to page across all devices without having to revert back to the previous page via the ‘back’ button.

![ nav bar ](/assets/images/nav-bar.md.jpg "Text to show on mouseover")

#### Hero Section

The hero section includes a photograph and some text explaining who we are at pitstop academy. The text has been styled to be big and bold to make it stand out against the background for good ux and accessability.
...
This section shows the user a breif description of the courses we provide and each course section has a call to action to either find out more information about the courses or apply to either one of the courses.

It has been made responsive for all devices where the image beside the course will disappear on smaller screen sizes to prevent content from overlapping.
...
This section also contain an iframe with an exact pin location on google maps so the user will know where to find us and how to get there. If clicked this will open in a new tab to prevent the user from being taking away from our website.
...
The footer contains links to all of our socail media which will open in a new tab if clicked by the user as so not to take them away from our website if clicked. It is designed to be simple and effective.

![ footer ](/assets/images/footer.md.jpg "Text to show on mouseover")
...
![ courses page ](/assets/images/courses-page.md.jpg "Text to show on mouseover")
...
They will be asked to provide their name, email, date of birth, phone number and address. They will also be asked to confirm whether they hold a full or provisional driving licence in Ireland. Applicants also have the chance to add their cv to the form and some additional information about themselves which they think might be useful. The last two fields will not be required to complete the form. Most fields are required and the correct syntax is needed to complete to course to ensure the user completes the form fully and correctly. If details are incorrectly added it will be made clear to the user so they can fix it.
...
- I would like to make my own success page on completion of the application forms to thank users for applying to our courses instead of using the https://formdump.codeinstitute.net/.

- I would like to change the layout of the apply now page when there are more courses available so that there is a link to the form for each course to open in a separate tab like displayed in the second form for the Roadside Breakdowns and Safety Course.
